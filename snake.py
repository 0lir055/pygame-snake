...
button1_text = button_font.render("Start Game", True, (0, 0, 0))  
button2_text = button_font.render("Quit", True, (0, 0, 0))  
button3_text = button_font.render("Controls", True, (0, 0, 0))  
...
button3_surface = pygame.Surface((button3_text.get_width() + 20, button3_text.get_height() + 10))

button1_surface.fill((255, 255, 255))  
button2_surface.fill((255, 255, 255))  
button3_surface.fill((255, 255, 255))  

button1_surface.blit(button1_text, (10, 5))
button2_surface.blit(button2_text, (10, 5))
button3_surface.blit(button3_text, (10, 5))


button1_x = (screen_width - button1_surface.get_width()) // 2
button1_y = (screen_height - button1_surface.get_height()) // 2 - 50  

button3_x = (screen_width - button3_surface.get_width()) // 2
button3_y = (screen_height - button3_surface.get_height()) // 2  

button2_x = (screen_width - button2_surface.get_width()) // 2
button2_y = (screen_height - button2_surface.get_height()) // 2 + 50  

screen.blit(button1_surface, (button1_x, button1_y))
screen.blit(button3_surface, (button3_x, button3_y))
...
while running:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if button3_x <= mouse_x <= button3_x + button3_surface.get_width() and button3_y <= mouse_y <= button3_y + button3_surface.get_height():
                subprocess.Popen(["python", "controls.py"])
                running = False
